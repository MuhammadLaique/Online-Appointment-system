<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BlogPage.aspx.cs" Inherits="SignalRChat.BlogPage" %>
                                ...
                                <ItemTemplate>
                                        ...
                                        <table >
                                            ...
                                            <tr>
                                                <h2>
                                                    <a href="#">
                                                        <asp:Label ID="Label2" CssClass="text-warning" runat="server" Text='<%#Eval("Topic").ToString()%>'> 
                                                        </asp:Label></a>
                                                </h2>
                                            </tr>
                                            <tr>
                                                <p class="lead">
                                                    by <a href="index.php">
                                                        <asp:Label ID="Label3" CssClass="text-warning" runat="server" Text='<%#Eval("Topic").ToString()%>'> 
                                                        </asp:Label></a>
                                                </p>
                                            </tr>
                                            <tr>
                                                <p>
                                                    ...
                                                    <asp:Label ID="Label4" CssClass="text-warning" runat="server" Text='<%#Eval("Date").ToString()+Eval("Time").ToString()%>'> 
                                                    </asp:Label>
                                                </p>
                                            </tr>
                                            <tr>
