<%@ Page Title="" Language="C#" MasterPageFile="~/Login.Master" AutoEventWireup="true" CodeBehind="PatientSignup.aspx.cs" Inherits="SignalRChat.PatientSignup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%--<div class="container">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                <asp:Label ID="Label3" runat="server" CssClass="col-md-2 control-label" Text="Your Domain"></asp:Label>
                <div class="col-md-3">
                    <select runat="server" class="form-control" id="SelectDomain">
                        <option value="@punjabpatientportal.com">@punjabpatientportal.com</option>
                    </select>   
            ...
            <div class="form-group">
                <asp:Label ID="Label4" runat="server" CssClass="col-md-2 control-label" Text="Cinfirm Password"></asp:Label>
                <div class="col-md-3">
